...
class Vecteur:
    ...
    def negatif(self):
        return self * (-1)
class Sphere:
    def __init__(self,couleur, position, rayon,reflexion):
        self.pos = position
        self.r = rayon
        self.col = couleur
    ...
    def intersection_droite(self,rayon):
        ...
        if delta == 0:
            ...
            return 0
class Plan:
    def __init__(self,couleur, position1, position2, position3):
        self.pos1 = position1
        self.pos2 = position2
        self.pos3 = position3
        self.col = couleur
    ...
    def intersection_droite(self,u,A):
        a,b,c,d = self.equation()
        k = -(a*A.C +b*a.y + c*a.z +d)/ (a*u.x + b* u.y + c*u.z)
        return max(0,k)
class Triangle:
    def __init__(self,couleur, position1, position2, position3,reflexion):
        self.pos1 = position1
        self.pos2 = position2
        self.pos3 = position3
    ...
    def intersection_droite(self, rayon):
        ...
        if scal == 0:
            ...
            dist_to_triangle = -scalaire(self.norm,rayon.ori + (self.norm * scalaire(self.norm,self.pos1)).negatif()) / scal
            q = rayon.vect * dist_to_triangle + rayon.ori
...
class Camera:
    def __init__(self, position, rotation, distance,rebonds):
        self.pos = position
        self.rot = rotation    # en radian
        self.D = distance
        self.rebond = rebonds  # nombre de rebond du rendi
class Image_:
    def __init__(self,longueur, hauteur, fond, nom_image):
        self.l = longueur
        self.h = hauteur
        self.fond = fond
        self.nom = nom_image
